...
<div class="panel panel-default" ng-hide="!editSummary">
	<div class="panel-body">
	    ...
	    <div class="form-group">
	      ...
	      <input ng-model="cert_fields['heading']" ng-init="cert_fields['heading']=' <% $cert_fields['heading'] %>'" type="text" class="form-control relative" maxlength="30" ng-trim="false" required>
	      <span  class="label label-info count ">{{30 - cert_fields['heading'].length}}</span>
	    </div>
	    <div class="form-group">
	      <p>Subheading</p>
	      <input ng-model="cert_fields['subheading']" ng-init="cert_fields['subheading']=' <% $cert_fields['subheading'] %>'" type="text" class="form-control relative" maxlength="45" required>
			...
			<table align="center" role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 55px;">
				<tr>
					...
					<td style="width: 40%; text-align: center; color: #9F2B30; font-size: 16px; font-family: 'Alegreya Sans', sans-serif; padding-top: 17px; padding-left: 50px;">
						...
						<input type="text" name="cert_fields['signature']" ng-model="cert_fields['signature']" ng-show="ownSignature" placeholder="Signature" style="position: absolute; width: 30%; font-size: 25px; border: 0; outline: none; background: transparent; text-align: center; font-family: 'Great Vibes', cursive; bottom: 195px; left: 120px;" disabled>

						<img id="signature" src="{{cert_fields['signature']}}"  class="file-return" style="position: absolute; left: 178px; bottom: 165px; width: 135px;" ng-model="cert_fields['signature']" ng-hide="ownSignature">
